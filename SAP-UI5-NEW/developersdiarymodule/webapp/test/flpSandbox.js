		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DevelopersDiary",
									"targetURL": "#nsdevelopersdiarymodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsdevelopersdiarymodule-display": {
								"semanticObject": "nsdevelopersdiarymodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.developersdiarymodule",
									"url": sap.ui.require.toUrl("ns/developersdiarymodule")
								}
							}
						}
					}
